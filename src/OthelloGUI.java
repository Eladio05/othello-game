...
public class OthelloGUI extends Application {
    ...
    private void createGame(){
        ...
        buttonBox.setAlignment(Pos.CENTER_RIGHT); // Aligner les boutons Ã  droite

        root.getChildren().add(buttonBox);  // Ajoutez la HBox Ã  la VBox principale aprÃ¨s le GridPane

        buttonBox.getChildren().addAll(restartButton, exitButton);

        restartButton.setOnAction(e -> restartGame());  // Nous allons dÃ©finir cette mÃ©thode plus loin.
